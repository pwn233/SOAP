 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://services/", wsdlLocation = "http://localhost:8080/CalculatorSOAPService/CalculatorService?WSDL")
public class CalculatorService_Service
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://services/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/CalculatorSOAPService/CalculatorService?WSDL");
    ...
    public CalculatorService getCalculatorServicePort() {
        return super.getPort(new QName("http://services/", "CalculatorServicePort"), CalculatorService.class);
    }
    ...
    public CalculatorService getCalculatorServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services/", "CalculatorServicePort"), CalculatorService.class, features);
    }
