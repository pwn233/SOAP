 ...
 * 
 */
@WebServiceClient(name = "HelloWebService", targetNamespace = "http://services/", wsdlLocation = "http://localhost:8080/WebServiceExample/HelloWebService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName HELLOWEBSERVICE_QNAME = new QName("http://services/", "HelloWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WebServiceExample/HelloWebService?WSDL");
    ...
    public HelloWebService getHelloWebServicePort() {
        return super.getPort(new QName("http://services/", "HelloWebServicePort"), HelloWebService.class);
    }
    ...
    public HelloWebService getHelloWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services/", "HelloWebServicePort"), HelloWebService.class, features);
    }
